...
typedef void (*PF_UINT82P1B)(uint8_t, const uint8_t*, uint8_t, bool);
static inline void app_receiveDataHandler(uint8_t instruction, const uint8_t *data, uint8_t size, bool broadcast)
{
